...
(
    ...
    [FrontDescription] NVARCHAR(400) NOT NULL,
...
CREATE NONCLUSTERED INDEX [IX_Notecards_CollectionId_FrontDescription_IsActive] ON [note].[Notecards] ([CollectionId], [FrontDescription]) 
WHERE [IsDeleted] = 0;
